...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: I notice that the test was failing because the AddPerson() function was saving in the wrong order
    // like before it was saving "Sue", "Tim" and "Bob" but it should be "Bob", "Tim" and "Sue", I fixed this issue
    ...
    // Defect(s) Found: This test was failing because the implementation of the GetNextPerson() was incomplete, 
